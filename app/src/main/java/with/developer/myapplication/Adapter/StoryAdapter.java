...
import with.developer.myapplication.AddStoryActivity;
import with.developer.myapplication.Model.Story;
import with.developer.myapplication.Model.User;
import with.developer.myapplication.R;
import with.developer.myapplication.StoryActivity;
...
public class StoryAdapter extends RecyclerView.Adapter<StoryAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        if (i == 0) {
            View view = LayoutInflater.from(mContext).inflate(R.layout.add_story, viewGroup, false);
